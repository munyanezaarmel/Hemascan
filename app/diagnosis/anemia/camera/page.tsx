...
export default function CameraCapturePage() {
  ...
  const handleImageReady = (imageData: string, source: "camera" | "upload") => {
    ...
    toast({
      title: "Image ready!",
      description: `Image ${source === "camera" ? "captured" : "uploaded"} successfully. Proceeding to patient details.`,
    })
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Choose your preferred method to provide an eye image for analysis</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Center your face in the frame or image</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Gently pull down your lower eyelid to show the inner surface
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-100 rounded-lg p-4 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">Choose camera or upload option below</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select how you'd like to provide your eye image</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <TabsContent value="camera" className="mt-6">
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-blue-50 rounded-lg">
                      ...
                      <h3 className="font-medium text-blue-900">Live Camera Capture</h3>
                      <p className="text-sm text-blue-700">
                        Use your device's camera to take a real-time photo of your eye
                      </p>
                    </div>
                    <CameraCapture
                      onCapture={(imageData) => handleImageReady(imageData, "camera")}
                      onError={handleError}
                    />
                  </div>
                </TabsContent>
                ...
                <TabsContent value="upload" className="mt-6">
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-green-50 rounded-lg">
                      ...
                      <h3 className="font-medium text-green-900">Upload Existing Image</h3>
                      <p className="text-sm text-green-700">
                        Select a photo from your device that shows your lower eyelid clearly
                      </p>
                    </div>
                    <ImageUpload
                      onUpload={(imageData) => handleImageReady(imageData, "upload")}
                      onError={handleError}
                    />
                  </div>
                </TabsContent>
